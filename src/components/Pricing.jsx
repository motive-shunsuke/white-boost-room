            ...
            <div className="container">
                ...
                <div className="pricing-banner bg-white">
                    <div className="banner-content">
                        ...
                        <span className="text-sub text-sm ml-2">いまなら無料！</span>
                    </div>
                </div>
                ...
                <div className="pricing-wrapper">
                    ...
                    <div className="pricing-item-row">
                        ...
                        <div className="pi-price">1,000<span className="unit">円/日</span></div>
                        <div className="pi-price">1,000<span className="unit">円/日</span></div>
                    </div>
                    ...
                    <div className="pricing-item-row">
                        ...
                        <div className="pi-price">4,500<span className="unit">円/月</span></div>
